...
const Favorite = () => {
    ...
    useEffect(()=>{
        ...
        setMovieFavorite(FavoriteFromLocalStorage)
      },[])
  ...
  return (
    <div className=''>
    <div className='text-Zxl text-white font-bold text-left  p-2 pl-6  '>Favorite Movies</div>
    ...
    <div style={{
     display:movieFavorite.length===0?'block' : 'none'
     }}>
     <div className="text-9xl mt-32 pl-32 sm:pl-40 text-white"> <RiImageAddLine/> </div>
     <div className="text-white text-wrap text-lg text-center pl-16 pr-16">you haven't added any movie to your Favorite</div>
     <div/>
     </div>
